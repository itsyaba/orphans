...
import { User, Phone, Mail, HelpCircle, PhoneCall, LocateIcon, MapIcon } from "lucide-react";
          ...
          >
            <div>
              ...
              <div className="flex items-start space-x-3 text-gray-600">
                ...
                <a href="tel:+404-483-3297">404-483-3297</a>
              </div>
              <div className="flex items-start space-x-3 text-gray-600 mt-2">
                <Mail className="h-5 w-5 mt-1 text-[#F47458]" />
                <p>Email: Huhtorphans21@gmail.com</p>
              </div>
              <div className="flex items-start space-x-3 text-gray-600 mt-2">
                <MapIcon className="h-5 w-5 mt-1 text-[#F47458]" />
                <p>Address: 9869 jasper street Commerce city Colorado 80022</p>
              </div>
            </div>
          </motion.div>
        </div>
